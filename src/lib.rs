...
#[derive(Debug)]
pub struct OmenYarnProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OmenYarnProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OmenYarn processing");
    
    let mut processor = OmenYarnProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OmenYarnProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OmenYarnProcessor::new(false);
